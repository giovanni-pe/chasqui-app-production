...
export interface BottomNavItem {
  id: string;
  label: string;
  icon: string;  // nombre Iconify, ej. "mdi:home"
  path: string;
  badge?: number;
  disabled?: boolean;
}
...
/* Navegación centralizada (composable migrado) */
const { navigate, isCurrentPathStartsWith } = useNavigation();

/* Clases raíz (puedes sobreescribir con :class="..." desde el padre) */
...
<template>
  <div :class="rootClass">
    ...
    <div
      class="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-1 bg-gradient-to-r
